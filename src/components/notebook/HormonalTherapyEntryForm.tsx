...
export function HormonalTherapyEntryForm() {
  ...
  const labels = lang === 'pl' ? {
    ...
    title: 'Hormontherapie — Tageseintrag',
    drug: 'Medikament',
    drugPlaceholder: 'z. B. Tamoxifen 20mg',
    taken: 'Heute genommen?',
    takenYes: 'Ja, genommen',
    takenNo: 'Nicht genommen',
    ...
    adherenceNote: 'Tägliches Protokollieren hilft, Adhärenz und Nebenwirkungen zu verfolgen',
  } : {
